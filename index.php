...
if(!isset($_SESSION['staff_role'])){
    echo "<script>location.assign('page-login.php');</script>";
}
if($_SESSION['staff_role'] == "admin" || $_SESSION['staff_role'] == "stylist" || $_SESSION['staff_role'] == "receptionist"){
$id = $_SESSION['login_id'];
    $query = mysqli_query($con,"select * from `tasks` where assigned_staff_id = $id");

    $row = mysqli_fetch_assoc($query);

    // echo "<scritp>alert('. $query .')</scritp>"
 ?>
